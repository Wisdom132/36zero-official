            ...
            <div class="col-md-6 offset-md-6">
                ...
                <form method="POST" action="{{ route('send.mail') }}">
                  ...
                  <div class="form-group">
                      ...
                      <input type="Email" name="email" class="form-control border-2 rounded-0 bg-transparent text-light" id="exampleInputPassword1">
                  </div>
                  <div class="form-group ">
                      <label for="exampleInputEmail1" require class="contact_label">Subject</label>
                      <input type="text" name="subject" class="form-control border-2 rounded-0 bg-transparent text-light" id="exampleInputEmail1" aria-describedby="emailHelp">
                  </div>
                  <div class="form-group">
                    <label for="exampleFormControlTextarea1" class="contact_label">Drop A Message</label>
                    <textarea name="body" require class="form-control border-2 rounded-0 bg-transparent text-light" id="exampleFormControlTextarea1" rows="5"></textarea>
                </div>
